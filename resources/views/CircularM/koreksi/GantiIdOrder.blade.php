    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-12 RDZMobilePaddingLR0">
                <div class="card">
                    <div class="card-header">Ganti Id Order</div>
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        <div class="form-container col-md-12">
                            ...
                            <div class="row pb-2">
                                <div class="col-sm-2">
                                    <label for="nama_mesin" class="form-label" style="font-weight: bold">Data Order</label>
                                </div>
                            </div>
                            ...
                            <div class="row pb-2">
                                <div class="col-sm-2">
                                    <label id="label_ganti" for="ganti_order" class="form-label">Ganti Order</label>
                                </div>
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="ganti_order" name="ganti_order">
                                </div>
                                <div class="col-sm-2">
