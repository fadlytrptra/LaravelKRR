    ...
    <div class="modal-dialog custom-modal-width2">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Preview Laporan Extruder</h5>
                ...
                <div class="laporan-extruder">
                    ...
                    <div class="container">
                        <table>
                            ...
                            <tr>
                                <td colspan="2" class="center bold textBener">LAPORAN PRODUKSI
                                    EXTRUDER</td>
                        ...
                        <table>
                            ...
                            <tr class="center small-text">
                                <td style="text-align: left; border-bottom:none !important;">Flange
                                    ( C )</td>
                                <td>FL</td>
                            ...
                            <tr class="center small-text">
                                <td style="text-align: left; border-top:none !important;">Joint ( C
                                    )</td>
                                <td>JN</td>
                        ...
                        <table>
                            <tr class="textBener">
                                ...
                                <td colspan="4" class="bold" style="text-align: center">
                                    SPEK :</td>
                            ...
                            <tr class="center small-text">
                                ...
                                <td class="small-text" id="kwhM2" contenteditable="true">
                                </td>
                                <td class="small-text" id="jamProd" contenteditable="true">
                                </td>
                            </tr>
                            <tr class="center small-text">
                                <td>P . P</td>
                            ...
                            <tr class="center small-text">
                                ...
                                <td style="text-align: left; border-right:none !important;">P1 =
                                </td>
                            ...
                            <tr class="center small-text">
                                ...
                                <td style="text-align: left; border-right:none !important;">P2 =
                                </td>
                            ...
                            <tr class="center small-text">
                                ...
                                <td style="text-align: left; border-right:none !important;">N . G
                                    -)</td>
                            ...
                            <tr class="center small-text">
                                ...
                                <td style="text-align: left; border-right:none !important;">
                                    &emsp;&emsp;&nbsp; -)</td>
                                <td style="border-right:none !important; border-left:none !important;"
                        ...
                        <table>
                            ...
                            <tr class="center small-text">
                                <td id="bngM" style="width: 40px" contenteditable="true">
                                    &nbsp;</td>
                                <td id="prongM" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="silM" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="bngL" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="prongL" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="silL" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="bngMe" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="prongMe" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="silMe" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="bngGB" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="prongGB" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="silGB" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="bngLL" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="prongLL" style="width: 40px" contenteditable="true">
                                </td>
                                <td id="silLL" style="width: 40px" contenteditable="true">
                                </td>
