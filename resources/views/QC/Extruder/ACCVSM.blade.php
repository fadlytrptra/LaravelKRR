...
@section('content')
@section('title', 'ACC SPV Verifikasi Setting Mesin Extruder')

<div class="container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-12 RDZMobilePaddingLR0">
            <div class="card">
                <div class="card-header">ACC SPV Verifikasi Setting Mesin Extruder</div>
...
<script type="text/javascript" src="{{ asset('js/QC/Extruder/ACCVSM.js') }}"></script>
@endsection
