...
<div class="modal fade"
     id="modalTambahBonKasMerah"
     tabindex="-1"
     aria-labelledby="modalTambahBonKasMerahLabel"
     aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-scrollable modal-tambah-bon-kas">
        ...
        <div class="modal-content">
                ...
                <div class="row align-items-center w-100">
                    ...
                    <div class="col-md-6">
                        <h4 class="modal-title mb-0"
                            id="modalTambahBonKasMerahLabel">
                            BON KAS MERAH
                        </h4>
                    </div>
            ...
            <div class="modal-body">
                ...
                {{-- FORM --}}
                <form id="formBonKasMerah" action="{{ route('bon-kas.store') }}" method="POST" enctype="multipart/form-data">
