@extends('layouts.app')
@section('title', 'List Bon Kas Merah')
@section('content')
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header bg-white">List Bon Kas Merah</div>
        <div class="card-body">
...
<button type="button" class="acs-icon-btn acs-add-btn acs-float" id="btn_tambahMerah" data-bs-toggle="modal" data-bs-target="#modalTambahBonKasMerah">
    <div class="acs-add-icon"></div>
    <div class="acs-btn-txt">Tambah Bon Kas</div>
</button>

{{--Modal List User--}}
<div class="modal fade" id="modalKirim" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg modal-kirim" role="document">
    ...
    Swal.fire({
        ...
        html: `
            <div>
                ...
                <p class="mb-0">
                    Kode Bon Kas:
                    <strong>{{ session('kodeBonKas') }}</strong>
                </p>
            </div>
        `,
