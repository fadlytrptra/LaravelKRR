@extends('layouts.app')
@section('title', 'List ACC Bon Kas')
@section('content')
...
<div class="container-fluid">
    <div class="card shadow-sm">
        <div class="card-header bg-white">List ACC Bon Kas</div>
        <div class="card-body">
            <div class="row g-2 mb-3">
                <div class="col-12 col-md-3">
                    <label>Tgl. Awal</label>
                    <input type="date" id="filterTanggalAwal" class="form-control">
                </div>
...
<script src="{{ asset('js/bonkasAcc.js') }}"></script>
