    ...
    <div class="modal-dialog custom-modal-width2">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabelL">Tambah Laporan</h5>
            ...
            <div class="modal-body">
                ...
                <button type="button" id="btn_print" class="btn btn-success mb-2" style="visibility: hidden">
                    Print
                </button>
                            ...
                            <table>
                                ...
                                <tr class="center small-text">
                                    <td
                                        style="width: 150px; text-align: left; border-bottom:none !important; border-right:none !important;">
                                        HAO (Hot Air Oven)</td>
                                    <td style="border-left:none !important;">( °C )</td>
