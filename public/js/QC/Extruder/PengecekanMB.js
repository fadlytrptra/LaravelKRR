    ...
    $("#table_atas").on("click", ".link-idheader", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                r11D.textContent = data.data[0].r11D;
                ...
                r10D.textContent = data.data[0].r10D;
                ...
                r9D.textContent = data.data[0].r9D;
                ...
                r8D.textContent = data.data[0].r8D;
                ...
                r7D.textContent = data.data[0].r7D;
                ...
                r6D.textContent = data.data[0].r6D;
                ...
                r5D.textContent = data.data[0].r5D;
                ...
                r4D.textContent = data.data[0].r4D;
                ...
                r3D.textContent = data.data[0].r3D;
                ...
                r2D.textContent = data.data[0].r2D;
                ...
                r1D.textContent = data.data[0].r1D;
                ...
                l1D.textContent = data.data[0].l1D;
                ...
                l2D.textContent = data.data[0].l2D;
                ...
                l3D.textContent = data.data[0].l3D;
                ...
                l4D.textContent = data.data[0].l4D;
                ...
                l5D.textContent = data.data[0].l5D;
                ...
                l6D.textContent = data.data[0].l6D;
                ...
                l7D.textContent = data.data[0].l7D;
                ...
                l8D.textContent = data.data[0].l8D;
                ...
                l9D.textContent = data.data[0].l9D;
                ...
                l10D.textContent = data.data[0].l10D;
                ...
                l11D.textContent = data.data[0].l11D;
                ...
                l12D.textContent = data.data[0].l12D;
                ...
                rrD.textContent = data.data[0].rrD;
