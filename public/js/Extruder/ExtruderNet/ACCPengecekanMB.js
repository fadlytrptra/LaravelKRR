    ...
    $("#table_atas").on("click", ".link-idheader", function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                bahan_pp.textContent = formatPrint(data.data[0].bahan_pp);
                ca_co3.textContent = formatPrint(data.data[0].ca_co3);
                uv.textContent = formatPrint(data.data[0].uv);
                m_bath.textContent = formatPrint(data.data[0].m_bath);
                lot_no.textContent = formatPrint(data.data[0].lot_no);
                spek.textContent = formatPrint(data.data[0].spek);
                range.textContent = formatPrint(data.data[0].range);
                ...
                r12Ket.textContent = formatPrint(data.data[0].r12Ket);
                ...
                r11Ket.textContent = formatPrint(data.data[0].r11Ket);
                ...
                r10Ket.textContent = formatPrint(data.data[0].r10Ket);
                ...
                r9Ket.textContent = formatPrint(data.data[0].r9Ket);
                ...
                r8Ket.textContent = formatPrint(data.data[0].r8Ket);
                ...
                r7Ket.textContent = formatPrint(data.data[0].r7Ket);
                ...
                r6Ket.textContent = formatPrint(data.data[0].r6Ket);
                ...
                r5Ket.textContent = formatPrint(data.data[0].r5Ket);
                ...
                r4Ket.textContent = formatPrint(data.data[0].r4Ket);
                ...
                r3Ket.textContent = formatPrint(data.data[0].r3Ket);
                ...
                r2Ket.textContent = formatPrint(data.data[0].r2Ket);
                ...
                r1Ket.textContent = formatPrint(data.data[0].r1Ket);
                ...
                l1Ket.textContent = formatPrint(data.data[0].l1Ket);
                ...
                l2Ket.textContent = formatPrint(data.data[0].l2Ket);
                ...
                l3Ket.textContent = formatPrint(data.data[0].l3Ket);
                ...
                l4Ket.textContent = formatPrint(data.data[0].l4Ket);
                ...
                l5Ket.textContent = formatPrint(data.data[0].l5Ket);
                ...
                l6Ket.textContent = formatPrint(data.data[0].l6Ket);
                ...
                l7Ket.textContent = formatPrint(data.data[0].l7Ket);
                ...
                l8Ket.textContent = formatPrint(data.data[0].l8Ket);
                ...
                l9Ket.textContent = formatPrint(data.data[0].l9Ket);
