jQuery(function ($) {
        ...
        table_bawah = $("#table_bawah").DataTable({
            ...
            columns: [
                ...
                { data: "NamaUser" },
                {
                    ...
                    render: function (data, type, row) {
                        let html = `
                            <button class="btn btn-sm btn-primary btn-view" style="width: 100px;" data-id="${row.id_laporan}">
    ...
    let id_laporan = null;
    $('#table_bawah').on('click', '.btn-view', function () {
